...
public class UIController implements View.OnClickListener, View.OnKeyListener {
    ...
    public void setContentView(View rootView) {
		...
		//String strCountry = localLocale.getCountry().toLowerCase();
		String strLang = localLocale.getLanguage().toLowerCase();
		
		String str = null;
		//if(strCountry.equals("es") && strLang.equals("es"))
        if(strLang.equals("es"))
		{
			str = "file:///android_asset/es/Help.htm";
		}else if(strLang.equals("zh")){
			str = "file:///android_asset/html/zh_tw/Help.htm";
		}
		else
		{
			str = "file:///android_asset/default/Help.htm";
		}
        ...
        switch (viewId) {
            case R.id.update_local:
               ...
               // activity.startActivityForResult(intent0, 0);
            	Intent intent0 = new Intent(mContext,SelectLocalmm.class);
            	Activity activity = (Activity) mContext;
            	activity.startActivityForResult(intent0, 0);
                break;
