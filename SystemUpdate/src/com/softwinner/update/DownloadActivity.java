...
public class DownloadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( intent.getBooleanExtra(UpdateService.KEY_DOWNLOAD_SUCESS, false)) {
    ...
    protected void onResume() {
    	super.onResume();
    	mPreference.setDownloadActivityRuning(true);
    }
    protected void onStop(){
    	super.onStop();
    	mPreference.setDownloadActivityRuning(false);
    }
    @Override
    ...
    private String setStr(long size,int status){
     ...
     private void createDiag(){
    	 float size=mPreference.getRemoteFileSize()/1024/1024;
    	 String msg=String.format(getString(R.string.Download_AlertDialog_mesg), Float.toString(size)+"M");
    	
    	 new AlertDialog.Builder(DownloadActivity.this).setTitle(getString(R.string.Download_AlertDialog_title))//设置标题
    	 .setMessage(msg)//设置提示消息
    	 .setPositiveButton(getString(R.string.Download_AlertDialog_OK),new DialogInterface.OnClickListener() {//设置确定的按键
    	             @Override
    	 ...
    	 .setNegativeButton(getString(R.string.Download_AlertDialog_set),new DialogInterface.OnClickListener() {//设置取消按键
    	            @Override
    	 public void onClick(DialogInterface dialog, int which) {
    	  ...
    	  .setNeutralButton(getString(R.string.Download_AlertDialog_cancel),new DialogInterface.OnClickListener() {//中立的，什么也不错
    	        @Override
    	 public void onClick(DialogInterface dialog, int which) {
    	         //do something
    	 }
