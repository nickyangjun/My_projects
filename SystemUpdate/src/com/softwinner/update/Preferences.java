...
public class Preferences {
    ...
    public static final String PREFS_RemtoFileSize = "";
    
    public static final String PREFS_BATTERYLEVL="batterylevel";
    
    public static final String PREFS_DOWNLOADACTIVIT = "downloadActivity";
    ...
    public void setRemoteFileSize(long size){
    	setLong(PREFS_RemtoFileSize, size);
    }
    ...
    public void setDownloadActivityRuning(Boolean bool){
    	setBoolean(PREFS_DOWNLOADACTIVIT,bool);
    }
    
    public void setBatterylevl(int persent){
    	setInt(PREFS_BATTERYLEVL,persent);
    }
    
    public int getBatterylevl(){
    	return mPrefs.getInt(PREFS_BATTERYLEVL, 0);
    }
    public String getPackageDescriptor(){
        return mPrefs.getString(PREFS_PACKAGE_DESCRIPTOR, "");
    }
    public long getRemoteFileSize(){
    	 return mPrefs.getLong(PREFS_RemtoFileSize, 0);
    }
    ...
    public boolean getDownloadActivityRuning(){
    	return mPrefs.getBoolean(PREFS_DOWNLOADACTIVIT,false);
    }
