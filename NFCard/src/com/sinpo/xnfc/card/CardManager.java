...
public final class CardManager {
	...
	public static String load(Parcelable parcelable, Resources res ,Context mContext) {
		...
		if (isodep != null) {
			Log.i("nick","----isodep------");
			return PbocCard.load(isodep, res,mContext);
		}
		
		final Ndef ndef = Ndef.get(tag);
		if(ndef != null){
			Log.i("nick","----Ndef------");
			return NdefCard.load(ndef, res,mContext);
		}
