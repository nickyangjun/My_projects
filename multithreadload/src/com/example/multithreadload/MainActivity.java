...
public class MainActivity extends ListActivity {
    ...
    //private static final String URL = "http://farm4.staticflickr.com/3755/";  
    private static final String URL = "http://192.168.6.215/down/img/"; 
    // 固定存放下载的音乐的路径：SD卡目录下  
 ...
 // 显示listView，这里可以随便添加  
    private void showListView() {  
        ...
        map.put("name", "cookie.bmp");  
        data.add(map);  
        map = new HashMap<String, String>();  
        map.put("name", "9148527824_6c156185ea.jpg");  
        data.add(map);  
        map = new HashMap<String, String>();  
        map.put("name", "cookie2.bmp");  
        data.add(map);  
        map = new HashMap<String, String>();  
   ...
   class DownloadTask extends AsyncTask<String, Integer, LoadInfo>{  
       ...
       protected void onPreExecute() {  
    	   Log.i("nick","AsyncTask:  onPreExecute");
       ...
       protected LoadInfo doInBackground(String... params) { 
    	   Log.i("nick","AsyncTask:  doInBackground");
           urlstr=params[0];  
       ...
       protected void onPostExecute(LoadInfo loadInfo) {  
    	   Log.i("nick","AsyncTask:  onPostExecute");
           if(loadInfo!=null){  
                // 显示进度条  
